...
public class FastCash extends JFrame implements ActionListener {
    ...
    String pinnumber; //Button names aren't changed so as to save time...
    FastCash(String pinnumber){
        ...
        image.add(text);//To appear text on image..
        ...
        setSize(900,900);
        setLocation(300,0);
        setUndecorated(true);//shows the frame without title column
        setVisible(true);
